...
<h1 style="text-align: center;">Sports Equipments</h1><br>
<form name="frmBooks" method="post">
<table style="background-color: blue; width: 100%; padding: 1px; border-spacing: 1px;">
...
<tr>
<td style="border: 2px solid maroon;">
<input type="checkbox" name="chkBook" value="Cricket Kit">
</td>
<td style="width: 340px; border: 2px solid maroon;">Cricket Kit</td>
</tr>
<tr>
<td style="border: 2px solid maroon;">
<input type="checkbox" name="chkBook" value="Football">
</td>
<td style="width: 340px; border: 2px solid maroon;">Football</td>
</tr>
<tr>
<td style="border: 2px solid maroon;">
<input type="checkbox" name="chkBook" value="Badminton">
</td>
<td style="width: 340px; border: 2px solid maroon;">Badminton</td>
</tr>
<tr>
<td style="border: 2px solid maroon;">
<input type="checkbox" name="chkBook" value="Tennis">
</td>
<td style="width: 340px; height: 24px; border: 2px solid maroon;">Tennis</td>
</tr>
<tr>
